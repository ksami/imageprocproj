...
%Dy1=centre_translated.eyeL.y-centre_face.eyeL.y;
%Dy2=centre_translated.eyeR.y-centre_face.eyeR.y;
Dy3=centre_translated.nose.y-centre_face.nose.y;
%Dy4=centre_translated.mouth.y-centre_face.mouth.y;
%Dy=mean([Dy1,Dy2,Dy3,Dy4]);

translation = [1 0 Dx3; 0 1 Dy3; 0 0 1];
